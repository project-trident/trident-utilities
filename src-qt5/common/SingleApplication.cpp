...
SingleApplication::SingleApplication(int &argc, char **argv, QString appname) : QApplication(argc, argv){
...
QString SingleApplication::getLockfileName(QString appname){
...
void SingleApplication::removeLocks(QString appname){
...
bool SingleApplication::isPrimaryProcess(){
  return (isActive || isBypass);
}

void SingleApplication::PerformLockChecks(){
...
void SingleApplication::newInputsAvailable(){
